...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Time Trials", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Time Trials", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Time Trials";
		app.meta["name"] = "Time Trials";
